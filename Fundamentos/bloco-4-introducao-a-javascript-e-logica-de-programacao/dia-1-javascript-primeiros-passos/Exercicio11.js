...
if (salarioBase <= 1903.98) {
  ...
  descontoIR = (salarioBase / 100) * 7.5 - 142.8
} else if (salarioBase >= 2826.66 && salarioBase <= 3751.05) {
  descontoIR = (salarioBase / 100) * 15 - 354.8
...
salarioReceber = salarioBase - descontoIR

console.log('Salário a receber R$', salarioReceber)
